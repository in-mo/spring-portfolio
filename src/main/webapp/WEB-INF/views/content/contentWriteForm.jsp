	...
	<div class="app" id="app">
		<form action="/content/write" method="post" enctype="multipart/form-data">
			...
			<div v-if="isPersonCountShow">
				...
				<hr>
				<button type="button" v-if="!isBathRoomCountShow" v-on:click="setBathRoomCountShow">욕실 수 정하기</button>
			</div>
			<div v-if="isBathRoomCountShow">
				...
				<hr>
				<button type="button" v-if="!isLocationShow" v-on:click="setLocationShow">숙소의 위치 정하기</button>
			</div>
			...
			<div v-if="isLocationShow">
				...
				<hr>
				<button type="button" v-if="!isAmenitiesShow" v-on:click="setAmenitiesShow">편의시설 정하기</button>
			</div>
			...
			<div v-if="isAmenitiesShow">
				...
				<hr>
				<button type="button" v-if="!isSafetyShow" v-on:click="setSafetyShow">안전시설 정하기</button>
			</div>
			...
			<div v-if="isSafetyShow">
				...
				<hr>
				<button type="button" v-if="!isUsefullShow" v-on:click="setUsefullShow">게스트 사용 공간 정하기</button>
			</div>
			<div v-if="isUsefullShow">
				...
				<hr>
				<button type="button" v-if="!isPicFileShow" v-on:click="setPicFileShow">사진 업로드하기</button>
			</div>
			...
			<div v-if="isPicFileShow">
				...
				<hr>
				<button type="button" v-if="!isExplanShow" v-on:click="setExplanShow">숙소 설명하기</button>
			</div>
			<div v-if="isExplanShow">
				...
				<hr>
				<button v-if="!isCostShow" v-on:click="setCostShow">숙소 요금 설정하기</button>
			</div>
			<div v-if="isCostShow">
				<h3>숙소 요금 설정하기</h3>
				...
				<hr>
				<button type="button" v-if="!isTitleShow" v-on:click="setTitleShow">숙소 제목 정하기</button>
			</div>
